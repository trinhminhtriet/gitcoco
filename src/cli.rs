...
#[derive(Debug, Parser)]
#[clap(name = "gitcoco", about = "Conventional commit tools", version)]
pub struct Opt {
    /// Run as if gitcoco was started in <path> instead of the current working directory.
    #[clap(short = 'C', global = true)]
    pub path: Option<PathBuf>,
    #[clap(short = 'c', long = "config", global = true, env = "GITCOCO_CONFIG")]
...
pub struct VersionCommand {
    ...
    #[clap(short, long, default_value = "v", env = "GITCOCO_PREFIX")]
    pub prefix: String,
    /// Print prefix in front of the semantic version
    #[clap(long, visible_alias = "pp", env = "GITCOCO_PRINT_PREFIX")]
    ...
    #[clap(short = 'P', long, env = "GITCOCO_PATHS")]
    ...
    #[clap(long, env = "GITCOCO_IGNORE_PRERELEASES")]
...
pub struct ChangelogCommand {
    ...
    #[clap(short, long, default_value = "v", env = "GITCOCO_PREFIX")]
    pub prefix: String,
    #[clap(default_value = "HEAD", env = "GITCOCO_REV")]
    pub rev: String,
    #[clap(short, long, env = "GITCOCO_SKIP_EMPTY")]
    pub skip_empty: bool,
    /// Limits the number of version tags to add in the changelog.
    #[clap(short, long, env = "GITCOCO_MAX_VERSIONS")]
    pub max_versions: Option<usize>,
    /// Only print this number of minor versions.
    #[clap(long, default_value_t=u64::MAX, hide_default_value=true, env = "GITCOCO_MAX_MINORS")]
    pub max_minors: u64,
    /// Only show this number of major versions.
    #[clap(long, default_value_t=u64::MAX, hide_default_value=true, env = "GITCOCO_MAX_MAJORS")]
    pub max_majors: u64,
    /// Only show this number of patch versions.
    #[clap(long, default_value_t=u64::MAX, hide_default_value=true, env = "GITCOCO_MAX_PATCHES")]
    pub max_patches: u64,
    /// Ignore pre-release versions when finding the last version
    #[clap(long, env = "GITCOCO_IGNORE_PRERELEASES")]
    pub ignore_prereleases: bool,
    /// Do not generate links. Overrides linkReferences and linkCompare in the config.
    #[clap(short, long, env = "GITCOCO_NO_LINKS")]
    pub no_links: bool,
    /// Include conventional merge commits (commits with more than 1 parent) in the changelog.
    #[clap(long, env = "GITCOCO_MERGES")]
    pub merges: bool,
    /// Print hidden sections
    #[clap(long, env = "GITCOCO_INCLUDE_HIDDEN_SECTIONS")]
    ...
    #[clap(long, env = "GITCOCO_LINE_LENGTH")]
    pub line_length: Option<usize>,
    /// Do not wrap lines.
    /// This only makes sense if the template makes use of `{{#word-wrap}}` blocks.
    #[clap(long, env = "GITCOCO_NO_WRAP")]
    pub no_wrap: bool,
    /// Change the title for the unreleased commits.
    /// If a semantic version is given, the title will be prefixed.
    #[clap(short, long, default_value = "Unreleased", env = "GITCOCO_UNRELEASED")]
    pub unreleased: String,
    /// Path to write the changelog to.
    #[clap(short, long, default_value = "-", env = "GITCOCO_OUTPUT")]
    pub output: PathBuf,
}
