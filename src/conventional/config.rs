...
pub(crate) struct Config {
    ...
    /// `commitTemplate`. An optional template file for gitcoco commit.
...
pub(crate) struct DescriptionLengthConfig {
    /// Define the minimum length of the description when using gitcoco commit
    #[serde(default = "default_some_10")]
    pub(crate) min: Option<usize>,
    /// Define the maximum length of the description when using gitcoco commit
...
mod tests {
    ...
    fn test_host_info_from_url() {
        ...
        assert_all(
            "http://github.com/trinhminhtriet/gitcoco",
            "http://github.com",
            "trinhminhtriet",
            "gitcoco",
        );
        ...
        assert_all(
            "scheme://git@github.com/trinhminhtriet/gitcoco.git",
            "https://github.com",
            "trinhminhtriet",
            "gitcoco",
        );
